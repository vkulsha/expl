...
function Filter(params) {
	...
	var jsTable = params && params.jsTable instanceof JsTable ? params.jsTable : new JsTable();
	...
	this.jsDistinctValuesOfCurrentColumn = new GetSet("jsDistinctValuesOfCurrentColumn", null, function(){
		...
		var q = "select distinct `"+column.name+"` from ("+queryAll+")xxx order by `"+column.name+"`";
