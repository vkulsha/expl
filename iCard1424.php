...
<script>
	...
	func(["Кадастровый паспорт", "Общая площадь", "Кадастровый номер", "Категория земель", "Разрешенное использование", "Кадастровая стоимость", "Обременения", "Лица обременения", "Дата постановки на ГКУ", "Дата документа", "Файлы", cn]);
