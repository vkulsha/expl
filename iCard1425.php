...
<script>
	...
	func(["Свидетельство о государственной регистрации права", "Объект права", "Адрес", "Субъект права", "Вид права", "Документы-основания", "Кадастровый номер", "Обременения", "Номер записи регистрации в ЕГРП", "Дата документа", "Файлы",cn]);
	func(["Технический паспорт", "Литера", "Инвентарный номер", "Общая площадь", "Полезная площадь", "Площадь застройки", "Число этажей", "Высота этажа", "Стены", "Перегородки", "Перекрытия", "Фундамент", "Год постройки", "Состояние", "Процент износа", "Дата документа", "Файлы", cn]);
